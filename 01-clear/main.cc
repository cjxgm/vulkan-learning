...
namespace application
{
    namespace priv
    {
        ...
        namespace pub
        {
            auto device(VkPhysicalDevice phy)
            {
                ...
                if (queue_family_idx == -1) return vk::device_handle{};
                return vk::device_simple(phy, queue_family_idx);
            }

            auto device(vk::instance_handle_cref instance)
            {
...
int main()
{
    ...
    auto device = app::device(instance);
    if (!device) {
